  ...
  return (
    <div className="pt-16">
      {products == {} ? (
        ...
        <div className="row">
          <div className="w-100 p-0 flex flex-col md:flex-row mx-3 justify-around">
            <Slider />
            <div className="flex w-full md:mt-0 mt-3  md:w-1/2">
              <div className="relative flex p-2 gap-3 rounded overflow-hidden shadow-lg">
                <div className="relative h-68 md:w-[40%]">
                  <img
                    className="w-[35%] md:w-[100%] md:justify-center md:h-full object-cover object-center transition-opacity duration-300 ease-in-out hover:opacity-50"
                ...
                <div className="relative h-68 md:w-[50%]">
                  <img
                    className="w-[35%] md:w-[100%] md:h-full object-cover object-center transition-opacity duration-300 ease-in-out hover:opacity-50"
          ...
          <div className="px-2 md:gap-2  md:max-w-full md:flex-shrink-0 md:flex md:flex-wrap md:flex-row md:items-start m-2 items-center flex flex-col w-full md:justify-normal">
            {availableProduct.map((item, key) => (
              <div className="max-w-sm rounded-lg overflow-hidden shadow-md mt-2 md:w-[24%] w-full" key={key} onClick={() => navigate(`/product-details/${item._id}`)}>
